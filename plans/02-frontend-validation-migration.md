...
- [~] Migrate remaining Phase 4+ forms:
  ...
  - [ ] Slips forms/pages complete migration
  - [ ] Settings forms complete migration
- [~] Remove residual ad-hoc page-level validators and error extractors.
...
- [ ] Typecheck/build pass after migration completion.
